...
#[allow(dead_code)] // US-003 wires this into the Route enum; the allow drops then.
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct TaskId(pub String);

impl TaskId {
    /// Borrow the inner string slice, matching `alps_core::domain::TaskId::as_str()`.
    #[allow(dead_code)] // US-003 wires this into the router, where it's live.
    ...
    #[allow(dead_code)] // US-003 wires this in for tests + fixture helpers.
...
impl From<alps_core::domain::TaskId> for TaskId {
    #[allow(dead_code)] // US-003, US-006 wire this on the router + server-function boundary.
